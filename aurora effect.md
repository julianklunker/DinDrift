### Implement this aurora effect on the blue banner in the section about the fact that only the imagination sets the limit for what possible with ai agent

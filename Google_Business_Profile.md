# DinDrift — Google Business Profile (Copy-Paste Ready)
...
```
> Tip: Google has no exact "AI" category yet. `Software Company` (primary) + `Business Management Consultant` is the strongest combo for what you sell. Add the others if Google offers them in the dropdown.

---

## 2. LOCATION & SERVICE AREA

You're a **service-area business** (you deliver remotely, clients don't visit an office). During setup choose **"No, I don't have a location customers can visit"** when asked — this hides your street address but keeps you rankable.

| Field | Value |
|---|---|
| **Base region** | `Aalborg, Denmark` |
| **Service areas** (add each) | `Aalborg` · `Nordjylland` · `Aarhus` · `Copenhagen` · `Denmark` |

> Listing the whole country plus the big cities lets you show up for "AI agent Aalborg", "AI automation Denmark", and major-city searches without faking a physical address.
...
> These match your "we reply within 24 hours on weekdays" promise. Adjust if your real availability differs.

**Add this attribute:** under *More hours / attributes*, mark **"Online appointments"** and **"Online estimates"** as available — both apply to you.

---

## 4. BUSINESS DESCRIPTION
*(750-character limit — this is 742. Paste as-is.)*

```
DinDrift builds custom AI agents that automate the repetitive tasks draining your business every day — appointment booking, email replies, no-show follow-ups, bookkeeping, review requests, and more.
...
> Have a repetitive workflow not covered above? DinDrift will scope, design, and build a tailored AI agent for your exact need. Previous builds span healthcare, hospitality, retail, trades, and professional services.

---

## 6. "FROM THE BUSINESS" — SHORT TAGLINE
*(Some profiles show a short opening line. Use this.)*

```
Custom AI agents that automate the busywork — built for Danish SMBs, delivered in 1–2 weeks.
```

---

## 7. MESSAGING AUTO-REPLY
...
## 8. QUESTIONS & ANSWERS
*(Post these yourself from your own account under "Q&A" so the answers are seeded correctly.)*

**Q: What types of businesses do you work with?**
A: We work with small and medium businesses across Aalborg and all of Denmark — including clinics, dentists, beauty salons, restaurants, consultants, accountants, tradespeople, and e-commerce stores. If you have repetitive tasks eating up your time, we can automate them.

**Q: How quickly can you deliver an AI agent?**
...
## 9. GOOGLE POSTS (publish 1–2× per week)
...
## 10. PHOTOS TO UPLOAD (in priority order)

1. **Logo** — square, clean, brand blue `#0015ff`
2. **Cover photo** — wide hero shot or branded graphic with the tagline
3. **Profile/headshot** — a photo of Julian (people trust faces; service businesses with an owner photo convert better)
4. **3–5 product screenshots** — a live agent booking an appointment, the website chatbot, an email draft, a review request
5. **A simple "how it works" graphic** — 3 steps: Discovery call → We build → Agent goes live

---

## 11. SEO KEYWORDS TO WEAVE IN
*(Use naturally in posts, service descriptions, and review replies — don't keyword-stuff.)*

- AI agent Aalborg
- AI automation small business Denmark
- automatisering af virksomhed
- AI chatbot hjemmeside
- bookingautomatisering
- AI til SMV
- kunstig intelligens Nordjylland
- automatisk mødebooking
- Google anmeldelse agent
- AI assistent virksomhed Danmark

---

## 12. LAUNCH CHECKLIST

- [ ] Claim/create the profile at business.google.com
- [ ] Choose "service-area business" (no public address)
- [ ] Paste name, category, phone, website, hours (sections 1–3)
- [ ] Paste the business description (section 4)
- [ ] Add all 8 services (section 5)
- [ ] Turn on messaging + set the auto-reply (section 7)
- [ ] Seed the 6 Q&As from your own account (section 8)
- [ ] Upload logo, headshot, and 3+ screenshots (section 10)
- [ ] Publish Post 1 (section 9)
- [ ] **Verify the listing** (Google mails a code / offers phone/video verification — required before you rank)
- [ ] Ask your first 3–5 clients for a Google review

---

## 13. ONGOING (after launch)

1. **Post weekly** — rotate through the 4 posts above, then write fresh ones (use the keywords).
2. **Reply to every review** — even "Tak, [navn]!" boosts ranking. Once your own Google Reviews Agent is live, use it.
3. **Keep info 100% complete** — Google ranks complete profiles higher. Fill every optional field.
4. **Check the "Performance" tab monthly** — track calls, website clicks, and direction requests to see what's working.

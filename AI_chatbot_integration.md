...
You are given a task to integrate an existing React component in the codebase. This following liquid glass button design is to be added to the chatbot outlining box

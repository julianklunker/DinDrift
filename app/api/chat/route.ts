...
Julian Zachar-Fink is a solo full-stack developer based in Aalborg, Denmark. CVR: 43486489. He builds bespoke AI automation agents and AI-powered solutions for businesses. He works directly with clients — no account managers, no agency overhead. Contact: dindriftai@gmail.com
...
- If you don't know the answer or are unsure, say so honestly and recommend the user reaches out directly via email: dindriftai@gmail.com
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!process.env.ANTHROPIC_API_KEY) {
      const fallback =
        language === "da"
          ? "Beklager, chatbotten er ikke tilgængelig lige nu. Kontakt os direkte på dindriftai@gmail.com."
          : "Sorry, the chatbot is not available right now. Please contact us at dindriftai@gmail.com."
    ...
    const fallback =
      "Something went wrong. Please reach out directly at dindriftai@gmail.com."
